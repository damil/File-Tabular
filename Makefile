...
PARENT_NAME = File
DLBASE = $(BASEEXT)
VERSION_FROM = lib/File/Tabular.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
TO_INST_PM = lib/File/Tabular.pm

PM_TO_BLIB = lib/File/Tabular.pm \
...
Tabular.def: Makefile.PL
	$(PERLRUN) -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME'=>\"File::Tabular\", 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
